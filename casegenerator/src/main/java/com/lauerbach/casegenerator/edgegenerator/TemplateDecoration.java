...
public abstract class TemplateDecoration implements EdgeTemplateElement {

	public abstract ContainerElement getTransformedElement(LineType lineType, Point offset, EdgeSide panelSide);
